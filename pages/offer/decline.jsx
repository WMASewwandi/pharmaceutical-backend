  ...
  const handleDeclineOffer = async () => {
    ...
    try {
      ...
      if (response.ok && responseData.statusCode === 200) {
        setStatus("success");
        setMessage("Offer declined. Thank you for your response.");
      } else {
        setStatus("error");
        setMessage(responseData.message || responseData.Message || "Failed to decline offer. Please contact HR.");
      }
    } catch (error) {
      setStatus("error");
        ...
        <CardContent sx={{ p: 4, textAlign: "center" }}>
          {loading && (
            <>
              ...
              <Typography variant="h6">Processing your response...</Typography>
            </>
          )}
...
export default OfferDeclinePage;
